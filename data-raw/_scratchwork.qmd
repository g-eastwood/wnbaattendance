...
write.csv(full_data, "clean_data/full_data.csv", row.names = FALSE)
...
write.csv(season_data, "clean_data/season_data.csv", row.names = FALSE)
...
df_aug <- augment(models$model_ols)
write.csv(df_aug, "clean_data/df_aug.csv", row.names = FALSE)
...
write.csv(data_plot, "clean_data/plotting_data.csv", row.names = FALSE)
...
plot_data <- augment(attendance_model, data = plot_data)
