...
interest or broader support for women's sports.
\end{abstract}
...
why fans choose to go games than the uncertainty of outcome hypothesis.
...
Winning percentage \emph{is} a measure of team strength. So how is this
different than what we're saying above?
...
National League teams; though the study did not establish causation both
ways. Lemke et al. (2010) found attendance increases as home team win
...
and determine that the women's game os significantly less balanced than
...
a factor in demand for attendance, we inquire further into whether
...
coverage; historical prejudice; poorer arena amenities and age; and
ticket prices, among others.

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Ben}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

Why would ticket prices decrease attendance? Aren't they lower in the
WNBA?
...
arenas in which WNBA teams play vary widely in size. The New York
...
14031 & SEA & HOU & Climate Pledge Arena & 6,116 & 1 & 0 & 0 \\ 
15590 & SAN & IND & AT\&T Center & 8,097 & -4 & 0 & 0 \\ 
11175 & CLE & WAS & Quicken Loans Arena & 12,537 & 17 & 0 & 0 \\ 
19175 & CHI & PHO & Wintrust Arena & 8,028 & 16 & 0 & 0 \\ 
15585 & CHI & LAS & Allstate Arena & 6,197 & 11 & 0 & 0 \\ 
14427 & IND & CON & Gainbridge Fieldhouse & 6,468 & 14 & 0 & 0 \\ 
15939 & CON & MIN & Mohegan Sun Arena & 7,088 & -14 & 0 & 0 \\ 
19983 & CON & MIN & Mohegan Sun Arena & 8,174 & -2 & 0 & 0 \\ 
16282 & TUL & ATL & BOK Center & 6,841 & -10 & 0 & 0 \\ 
16976 & MIN & LAS & Target Center & 13,003 & -18 & 0 & 0 \\ 
\bottomrule
\end{tabular*}
...
viewed as the league's best player. As a superior played with less
...
Washington and Connecticut may have been trying to maximize the
percentage of arena capacity at the expense of drawing larger crowds. Or
perhaps they didn't have a larger arena in which to play. Just two of
the 27 sellouts at Gainbridge Fieldhouse occurred before Clark's
arrival.
...
also include the team name (\(\phi_1\)), as well as the metropolitan
area median income (\(\phi_2\), in thousands of USD) and population
(\(\phi_3\), in millions) of the home city\footnote{The data for the
  population and the median income of cities comes from the American
  Community Survey, access to which was provided in R by the
  \textbf{tidycensus} package. Because the population and median income
  ...
  forward (or backward) for extraploted values.}. Finally, we include an
indicator based on whether Caitlin Clark or A'ja Wilson played more than
0 minutes in the game (\(\chi_1, \chi_2\), respectively).
...
interest are highlighted. Note the relatively large size of the
...
Figure~\ref{fig-season-coefs} isolates the changes intercept associated
with each WNBA season. These reveal that even after controlling for our
others variables---including the Caitlin Clark effect---expected
attendance has exceeded its 1997 baseline in the most recent seasons.
Thus, after controlling for the influence of Clark and Wilson, league
expected attendance has fully recovered from the COVID-19 pandemic and
the malaise of the early 2000s and 2010s.
...
uncertainty of the outcome. The slope associated with loss aversion
always positive and generally increasing, suggesting that the attendance
response to home win probability has strengthened over the league's
history. This suggests that fan behavior in the WNBA may becoming more
similar to the behavior observed in MLB by Coates et al. (2014).
