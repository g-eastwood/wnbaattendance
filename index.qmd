...
ggplot(slopes, aes(x = season, y = estimate)) +
  ...
  labs(
    x = "Season",
    y = "Estimated Attendance Slope",
    title = "Evolution of Attendance Drivers Over Time"
  )
```
